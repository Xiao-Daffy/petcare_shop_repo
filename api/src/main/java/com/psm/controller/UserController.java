...
public class UserController {
    ...
    */
    ...
    public ResultVO viewAddress(@PathVariable("uid") String uid){
        return userService.getListAddress(uid);
    }
    ...
    public ResultVO getAddress(@PathVariable("aid") String aid){
        return userService.getAddress(aid);
    }
    ...
    public ResultVO editAddress(@RequestBody UserAddress userAddress){
        return userService.updateAddressInfo(userAddress);
    }
